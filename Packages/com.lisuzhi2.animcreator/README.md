...
<root>
  ...
  ├── Editor
  │   ├── Lisuzhi2.Animcreator.Editor.asmdef
  │   └── EditorExample.cs
  ├── Runtime
  │   ├── Lisuzhi2.Animcreator.asmdef
  │   └── RuntimeExample.cs
  ├── Tests
  │   ├── .tests.json
  │   ├── Editor
  │   │   ├── Lisuzhi2.Animcreator.Editor.Tests.asmdef
  │   │   └── EditorExampleTest.cs
  │   └── Runtime
  │        ├── Lisuzhi2.Animcreator.Tests.asmdef
...
1. Enter your package name. The name you choose should contain your default organization followed by the name you typed. For example: `Lisuzhi2.Animcreator`.
...
To use the Inspector, select the `package.json` file in the Project browser. The **Package AnimCreator Manifest** page opens for editing.
...
* Store Editor-specific code under a root editor assembly definition file:
  ...
  `Editor/Lisuzhi2.Animcreator.Editor.asmdef`

* Store runtime-specific code under a root runtime assembly definition file:

  `Runtime/Lisuzhi2.Animcreator.asmdef`

* Configure related test assemblies for your editor and runtime scripts:

  `Tests/Editor/Lisuzhi2.Animcreator.Editor.Tests.asmdef`

  `Tests/Runtime/Lisuzhi2.Animcreator.Tests.asmdef`
...
Use the `Documentations~/AnimCreator.md` documentation file to create preliminary, high-level documentation. This document should introduce users to the features and sample files included in your package.  Your package documentation files will be used to generate online and local docs, available from the Package Manager UI.
